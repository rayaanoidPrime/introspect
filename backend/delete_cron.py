# goes throgh the agent-assets/analysis-assets/datasets folder in the volume
...
files = os.listdir("/agents-assets/analysis-assets/datasets")
# print current time
...
for file in files:
    ...
    if file.endswith(".feather"):
        file_path = "/agents-assets/analysis-assets/datasets/" + file
