...
**Guidelines**
1. *Case insensitive string search*: Unless a reference query explicitly shows otherwise—or the column represents a categorical value—perform case-insensitive matching
