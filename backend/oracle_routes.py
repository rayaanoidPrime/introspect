...
async def oracle_test_stage(req: Request):
    ...
    if stage == TaskStage.GATHER_CONTEXT.value:
        ...
        """
        Generates an optimization task, runs it, and generates recommendations based on explore and gather_context stage's outputs.
        ...
        - optimization_task_type: dict - The type of optimization task that was generated. Can be `simple_recommendation` or `run_optimizer_model`.
        - outputs: dict - Outputs of running the above sub task.
