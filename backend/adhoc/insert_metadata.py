...
# insert metadata for macmillan
macmillan_metadata = {
    "mv_enrollments_activations_ai": [
        {
            "data_type": "boolean",
            "column_name": "inclusive_access",
            "column_description": "Represents whether or not this was an inclusive access enrollment",
        },
        {
            "data_type": "boolean",
            "column_name": "is_paid",
            "column_description": "Indicates whether the access is paid.",
        },
        {
            "data_type": "boolean",
            "column_name": "is_college",
            "column_description": "Indicates whether the data pertains to college users.",
        },
        {
            "data_type": "integer",
            "column_name": "year",
            "column_description": "The year that a given enrollment was started.",
        },
        {"data_type": "integer", "column_name": "month", "column_description": ""},
        {
            "data_type": "text",
        ...
        },
        {
            ...
            "column_description": "Some possible values can be Physics, Chemistry, Psychology etc. This might also include other values.",
        },
        {"data_type": "text", "column_name": "category", "column_description": ""},
        {"data_type": "text", "column_name": "territory", "column_description": ""},
        {"data_type": "text", "column_name": "sfdc_state", "column_description": ""},
        {"data_type": "text", "column_name": "sfdc_country", "column_description": ""},
        {"data_type": "text", "column_name": "sfdc_city", "column_description": ""},
        {"data_type": "text", "column_name": "project_title", "column_description": ""},
        {"data_type": "text", "column_name": "division", "column_description": ""},
        {
            "data_type": "text",
            "column_name": "platform",
            "column_description": 'The only possible values for this are: "Sapling", "Achieve", "Launchpad"',
        },
        {
            "data_type": "text",
            "column_name": "region",
            "column_description": "The region where the enrollments or activations are coming from",
        },
        {
            "data_type": "text",
            "column_name": "school",
            "column_description": "The school or group associated with the enrollment",
        },
        {
            "data_type": "date",
            "column_name": "date",
            "column_description": "The date the enrollment started.",
        },
        {
            "data_type": "integer",
            "column_name": "enrollments",
            "column_description": "",
        },
        {
            "data_type": "text",
            "column_name": "channel",
            "column_description": 'The only possible values for this are: "Student Store", "Access Code", "Inclusive Access Course", "LMS Integration", "Launchpad", "Trial", "Unpaid", "Inclusive Access", "Bookstore Cards", "Braintree", "Others", and "Unknown"',
        },
    ]
}

macmillan_api_key = "Macmillan"
try:
    with engine.begin() as conn:
        for table in macmillan_metadata:
            for column in macmillan_metadata[table]:
                conn.execute(
                    insert(DefogMetadata).values(
                        api_key=macmillan_api_key,
                        table_name=table,
                        column_name=column["column_name"],
                        data_type=column["data_type"],
                        column_description=column["column_description"],
