...
--
-- Name: defog_api_stats; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.defog_api_stats (
    id integer NOT NULL,
    api_key text,
    question text,
    requested_at text
...
ALTER TABLE public.defog_api_stats OWNER TO postgres;

--
-- Name: defog_api_stats_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.defog_api_stats_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.defog_api_stats_id_seq OWNER TO postgres;

--
-- Name: defog_api_stats_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.defog_api_stats_id_seq OWNED BY public.defog_api_stats.id;
